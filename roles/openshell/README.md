...
| --- | --- | --- |
| `openshell_version` | `0.0.99` | Pinned OpenShell CLI and gateway release. |
...
The default checksums correspond to v0.0.99 x86_64 release artifacts. Override the version, archive URLs, and both checksums together only after verifying the upstream release checksums.
